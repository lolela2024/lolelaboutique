...
import { z } from "zod";
import { editCompany } from "../_actions/company";
import {
  Form,
  FormControl,
  FormField,
...
import { PersoanaJuridica } from "@prisma/client";

export default function EditCompanyForm({
  data,
}: {
  data: PersoanaJuridica | null;
}) {
  ...
  const onSubmit = (values: z.infer<typeof CompanySchema>) => {
    ...
    startTransition(() => {
      editCompany(values, data?.id as number).then((data) => {
        setError(data.error);
