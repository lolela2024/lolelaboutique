...
import { Unavailable } from "@prisma/client";
...
export default function StockProductsEdit({
  fields,
  unavailableValues,
  availableValue,
}: {
  ...
  const [unavailable, setUnavailable] = useState({
    ...
    qualityControl: unavailableValues?.qualityControl || 0,
    safetyStock: unavailableValues?.safetyStock || 0,
    other: unavailableValues?.other || 0,
  });
  const [available, setAvailable] = useState(availableValue);
